...
#define DURATION_TO_START APP_TIMER_TICKS(0)
#define DURATION_TO_UP APP_TIMER_TICKS(80)
#define DURATION_TO_UP_SLOW APP_TIMER_TICKS(19975) // 50Hz, 20000 - 5 - 5 - 10 - 5
#define DURATION_TO_SELECT APP_TIMER_TICKS(0)
#define DURATION_TO_SELECT_FROM_SLEEP APP_TIMER_TICKS(5)
#define DURATION_TO_PREV APP_TIMER_TICKS(5)
#define DURATION_TO_READ APP_TIMER_TICKS(10)
#define DURATION_TO_RESET APP_TIMER_TICKS(5)
#define ONE_SECOND APP_TIMER_TICKS(1 * 1000 * 1000) // -O.O-
